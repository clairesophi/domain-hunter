...
def api_seed_tree():
    """Pure embedding-neighbor mode: one input word → flat ranked list of
    semantically-closest vocab words. No categories, no branches — just
    cosine similarity to the seed, sorted high to low.
    """
